...
export const characters: Character[] = [
  {
    ...
    age: 52,
    description: [
      'Президент холдинга «Омега» с 2018 года.',
      'Один из участников создания холдинга, и акционер компании, владеющий 8% акций холдинга.',
      'До 2018 года являлся Директором Департамента инвестиционных проектов в ФПГ «ТрансИнвест», принимал непосредственное участие в скупке производственных активов холдинга «Омега».',
    ],
    support: 15,
    titleSort: 1,
  },
